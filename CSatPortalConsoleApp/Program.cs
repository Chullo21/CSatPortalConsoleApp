...
namespace CSatPortalConsoleApp
{
    internal class Program
    {
        ...
        {
            var reps = _Db.IssueDbs.Where(j => !j.Has8D);
        ...
        private static List<string> ListOfQA()
        {
            ...
            {
                Emails = _Db.AccountsDbs.Where(j => j.Section == "QA" || j.Section == "QAManager").Select(j => j.Email).ToList();
            }
        ...
        private static void CheckVals(CSatDbEntities _Db)
        {
            ...
            foreach (var validation in validations)
            {
                ...
                if (Days == 1)
                {
                    ...
                    emails.AddRange(_Db.AccountsDbs.Where(j => j.Section == "QA" || j.Section == "QAManager" || j.Section == "VicePresident").Select(j => j.Email));
                ...
                else if (Days < 1)
                {
                    string validationBody =
                        "Good day!\r\n" +
                        "Please be advised that a pending issue with issue# of " + validation.IssueNo + " is still unvalidated.\r\n" +
                        "This is an overdue reminder. Process this immediately.\r\n" +
                        "Have a great day!" +
                        "\r\n\r\n\r\n\r\n\r\n\r\nThis is an email generated by our CSat Portal, please refrain from replying.";
                ...
                else if (Days > 1 && DateTime.Now.DayOfWeek != DayOfWeek.Saturday && DateTime.Now.DayOfWeek != DayOfWeek.Sunday)
                {
                    string validationBody =
                        "Good day!" +
                        "\r\nPlease be advised that a pending issue with issue# of " + validation.IssueNo + " is still unvalidated.\r\n" +
                        "This is a daily reminder to process your QI immediately. \r\n" +
                        "Have a great day!" +
                        "\r\n\r\n\r\n\r\n\r\n\r\nThis is an email generated by our CSat Portal, please refrain from replying.";

                    emails.AddRange(_Db.AccountsDbs.Where(j => j.Section == "QA" || j.Section == "QAManager").Select(j => j.Email));
        ...
        static List<string> GetActionEmail(string pic)
        {
            ...
            {
                List<string> emails = new List<string>();
                var getPIC = _Db.AccountsDbs.FirstOrDefault(j => j.AccName == pic);
                ...
                var Manager = _Db.AccountsDbs.FirstOrDefault(j => j.Section == sectionManager);
